...
This is consistent with the current VSmux architecture, where terminal sessions already live in a detached host process and can outlive a single UI instance.
