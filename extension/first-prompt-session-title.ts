...
export function isGenericAgentSessionTitle(
   ...
   * First-prompt title generation may only name effectively untitled sessions.
   * Placeholder creation names and path-like shell titles are still eligible;
   * meaningful user, terminal-auto, or generated titles block generation so
   * hooks cannot overwrite established session names.
   */
