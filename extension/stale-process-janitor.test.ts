  ...
  test("should parse pid, ppid, and full command lines", () => {
    expect(
      parseUnixProcessList(
        [
          "123 1 node /Users/test/.vscode/extensions/maddada.vsmux-4.4.1/out/extension/terminal-daemon-process.js",
      ...
      {
        command:
          "node /Users/test/.vscode/extensions/maddada.vsmux-4.4.1/out/extension/terminal-daemon-process.js",
        pid: 123,
        ppid: 1,
      },
      {
  ...
  test("should leave current-version orphaned helpers alone so timeout-based resume still works", () => {
    const pids = selectStaleVsmuxProcessIds(
      [
        ...
        {
          command:
            "opencode serve VSMUX_AGENT=opencode OPENCODE_CONFIG_DIR=/Users/test/Library/Application Support/Code/User/globalStorage/maddada.vsmux/terminal-host-daemon/agent-shell-integration/hooks/opencode",
          pid: 102,
          ppid: 1,
        },
        {
          command:
            "node /Users/test/.vscode/extensions/maddada.vsmux-4.4.1/out/extension/agent-shell-wrapper-runner.js",
          pid: 103,
          ppid: 900,
        },
      ],
  ...
  test("should select orphaned old-version owned descendants", () => {
    const pids = selectStaleVsmuxProcessIds(
      [
        {
          command:
            "opencode serve VSMUX_AGENT=opencode OPENCODE_CONFIG_DIR=/Users/test/Library/Application Support/Code/User/globalStorage/maddada.vsmux/terminal-host-daemon /Users/test/.vscode/extensions/maddada.vsmux-4.3.1/out/extension/agent-shell-wrapper-runner.js",
          pid: 301,
          ppid: 1,
        },
      ],
