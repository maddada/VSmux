...
describe("browser tab detection log", () => {
  ...
  test("writes browser tab traces into the workspace .vsmux folder when debugging is enabled", async () => {
    ...
    expect(logPath).toBe(path.join(workspaceRoot, ".vsmux", "browser-tab-detection-debug.log"));
