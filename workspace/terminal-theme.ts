...
export function getTerminalTheme(): ITheme {
  ...
  return {
    ...
    black: getCssColor(styles, ["--vscode-terminal-ansiBlack"], fallbackDarkTheme.black ?? "#000000"),
    ...
    green: getCssColor(styles, ["--vscode-terminal-ansiGreen"], fallbackDarkTheme.green ?? "#0dbc79"),
    magenta: getCssColor(
      styles,
    ...
    white: getCssColor(styles, ["--vscode-terminal-ansiWhite"], fallbackDarkTheme.white ?? "#e5e5e5"),
    yellow: getCssColor(styles, ["--vscode-terminal-ansiYellow"], fallbackDarkTheme.yellow ?? "#e5e510"),
  };
}
