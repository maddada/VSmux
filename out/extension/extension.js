...
function activate(context) {
    ...
    context.subscriptions.push(workspace, vscode.window.registerWebviewViewProvider(native_terminal_workspace_1.SESSIONS_VIEW_ID, workspace.sidebarProvider), registerCommand("agentCanvasX.openWorkspace", () => workspace.openWorkspace()), registerCommand("agentCanvasX.openSettings", () => workspace.openSettings()), registerCommand("agentCanvasX.createSession", () => workspace.createSession()), registerCommand("agentCanvasX.revealSession", () => workspace.revealSession()), registerCommand("agentCanvasX.restartSession", () => workspace.restartSessionFromCommand()), registerCommand("agentCanvasX.focusUp", () => workspace.focusDirection("up")), registerCommand("agentCanvasX.focusRight", () => workspace.focusDirection("right")), registerCommand("agentCanvasX.focusDown", () => workspace.focusDirection("down")), registerCommand("agentCanvasX.focusLeft", () => workspace.focusDirection("left")), registerVisibleCountCommand("agentCanvasX.showOne", workspace, 1), registerVisibleCountCommand("agentCanvasX.showTwo", workspace, 2), registerVisibleCountCommand("agentCanvasX.showThree", workspace, 3), registerVisibleCountCommand("agentCanvasX.showFour", workspace, 4), registerVisibleCountCommand("agentCanvasX.showSix", workspace, 6), registerVisibleCountCommand("agentCanvasX.showNine", workspace, 9), registerViewModeCommand("agentCanvasX.setHorizontalView", workspace, "horizontal"), registerViewModeCommand("agentCanvasX.setVerticalView", workspace, "vertical"), registerViewModeCommand("agentCanvasX.setGridView", workspace, "grid"), registerCommand("agentCanvasX.resetWorkspace", () => workspace.resetWorkspace()));
